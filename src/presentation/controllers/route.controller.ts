...
import { RouteConstraints } from '../../domain/value-objects';
import { GetFastestRouteDto, RouteResponseDto } from '../dtos';

/**
 * Controller handling route calculation endpoints
 */
@ApiTags('routes')
@Controller()
export class RouteController {
   ...
   * Calculate the fastest route between two cities
   *
   * @param dto - Request body containing start city, end city, and optional constraints
   * @returns The calculated route with path, distance, time, and detailed steps
   * @throws HttpException if cities are not found or if validation fails
   */
  @Post('/get-fastest-route')
