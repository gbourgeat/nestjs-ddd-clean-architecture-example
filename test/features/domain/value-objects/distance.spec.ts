...
describe('Distance', () => {
  ...
  it('should return failure Result for negative distance', () => {
    const result = Distance.fromKilometers(-10);
  ...
  it('should return success Result for valid distance', () => {
    const result = Distance.fromKilometers(100);
  ...
  it('should convert kilometers to meters', () => {
    const distance = Distance.fromKilometersOrThrow(5);
    expect(distance.meters).toBe(5000);
  });

  it('should compare distances', () => {
    const dist1 = Distance.fromKilometersOrThrow(100);
    const dist2 = Distance.fromKilometersOrThrow(200);
  ...
  it('should check equality of distances', () => {
    const dist1 = Distance.fromKilometersOrThrow(100);
    const dist2 = Distance.fromKilometersOrThrow(100);
    expect(dist1.equals(dist2)).toBe(true);
  });

  it('should add distances', () => {
    const dist1 = Distance.fromKilometersOrThrow(100);
    const dist2 = Distance.fromKilometersOrThrow(50);
    const sum = dist1.add(dist2);
    expect(sum.kilometers).toBe(150);
  });

  it('should convert to string', () => {
    const distance = Distance.fromKilometersOrThrow(100);
